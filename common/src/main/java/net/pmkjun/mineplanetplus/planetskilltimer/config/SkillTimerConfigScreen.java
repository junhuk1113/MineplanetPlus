...
public class SkillTimerConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        for(int i = 0; i < 4 ; i++) {
            ...
            switch (i) {
                case 0:
                    toggleSkillsButton[i] = Button.builder(text, button -> toggleSkills(0))
                    ...
                    break;
                case 1:
                    toggleSkillsButton[i] = Button.builder(text, button -> toggleSkills(1))
                            .pos(5+getRegularX(), 5+getRegularY()+(20+2)*(i+2))
                            .size(137, 20)
                    ...
                    break;
                case 2:
                    toggleSkillsButton[i] = Button.builder(text, button -> toggleSkills(2))
                            .pos(5+getRegularX(), 5+getRegularY()+(20+2)*(i+2))
                            .size(137, 20)
                    ...
                    break;
                case 3:
                    toggleSkillsButton[i] = Button.builder(text, button -> toggleSkills(3))
                            .pos(5+getRegularX(), 5+getRegularY()+(20+2)*(i+2))
                            .size(137, 20)
    ...
    int getRegularX() {
        return  mc.getWindow().getGuiScaledWidth() / 2 - this.bgWidth / 2;
    }

    int getRegularY() {
        return mc.getWindow().getGuiScaledHeight() / 2 - this.bgHeight / 2;
    }
