...
public class DungeonSkill{
    //용기사
    private static final ResourceLocation DRAGON_DASH_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dragon_dash.png");
    private static final ResourceLocation DRAGON_WHEEL_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dragon_wheel.png");
    private static final ResourceLocation DRAGON_BREATH_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dragon_breath.png");
    private static final ResourceLocation DRAGON_SMASH_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dragon_smash.png");
    private static final ResourceLocation DRAGON_FURY_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dragon_fury.png");
    //어새신
    private static final ResourceLocation BLADE_DASH_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/blade_dash.png");
    private static final ResourceLocation THRUST_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/thrust.png"); 
    private static final ResourceLocation DAGGER_THROW_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/dagger_throw.png");
    private static final ResourceLocation BLADE_SPIN_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/blade_spin.png");
    private static final ResourceLocation BLADE_DANCE_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/blade_dance.png");
    //무투가
    private static final ResourceLocation AGILE_STRIKE_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/agile_strike.png");
    private static final ResourceLocation UPPERCUT_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/uppercut.png");
    private static final ResourceLocation DIVING_STRIKE_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/diving_strike.png");
    private static final ResourceLocation MARTIAL_DRIVE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/martial_drive.png");
    private static final ResourceLocation MULTIPLE_BLOW_TEXTURE = ResourceLocation.fromNamespaceAndPath("dungeonhelper", "textures/icon/skill/multiple_blow.png");
    //배틀메이지
