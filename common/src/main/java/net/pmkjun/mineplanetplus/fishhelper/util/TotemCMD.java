...
public class TotemCMD {
    public static Component getComponent() {
        ...
        for (TotemData totemData : totemDataList) {
            ...
            if(totemData.totemSlotString == null) {
                ...
                event = new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                        Component.literal("토템 정보\n").withStyle(Style.EMPTY.withColor(0x84CA77))
                                ...
                                .append(Component.literal("범위 : ").withStyle(ChatFormatting.RED))
                                .append(Component.literal(totemData.valueTotemRange + "").withColor(0x4CBDFF))
                                .append(Component.literal("블록\n").withColor(0xCAD1E0))
                                .append(Component.literal("토템 공유 비율 : " + totemData.shareTotemPercentage + "%\n").withColor(0x4CBDFF))
                                .append(Component.literal("신비한 옹달샘 : ").withStyle(ChatFormatting.DARK_PURPLE))
                                .append(koreanBool(totemData.isMythicalWaterActive))
                                .append(Component.literal("숙련된 낚시꾼 : ").withColor(0x84CA77))
                                .append(koreanBool(totemData.isExpBoosterActive))
                                .append(Component.literal("오버 핫스팟 : ").withColor(0xFFE679))
                                .append(koreanBool(totemData.isOverHotspotActive))
                                .append(Component.literal("트레져 헌터 : ").withColor(0xFFA453))
                                .append(koreanBool(totemData.isTreasureHunterActive))
                                .append(Component.literal("엔트로피 호더 : ").withColor(0x4CBDFF))
                                .append(koreanBool(totemData.isEntropyHoarder))
                                .append(Component.literal("토템 슬롯 : ").withColor(0x4CBDFF))
                                .append(Component.literal(totemData.totemSlotString).withStyle(ChatFormatting.AQUA))
    ...
    private static Component koreanBool(boolean bool){
        if(bool) return Component.literal("활성화\n").withColor(0x84CA77);
        else return Component.literal("비활성화\n").withStyle(ChatFormatting.RED);
    }
}
