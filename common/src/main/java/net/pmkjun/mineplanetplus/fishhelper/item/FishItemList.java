...
public class FishItemList {
    ...
    public static FishType getFishType(Component itemComponent){
        for (String fishName : FishItemList.MYTHIC_FISH_LIST) {
            if (itemComponent.getString().contains(fishName)) {
                return FishType.MYTHIC;
            }
        }
    ...
    /*public static String getFishName(Component message){
        for (String fishName : FishItemList.MYTHIC_FISH_LIST) {
